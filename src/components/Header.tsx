    ...
    <header className="bg-gradient-to-r from-blue-900 to-blue-800 text-white">
      <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center">
          <a 
            ...
            className="bg-yellow-500 text-blue-900 px-4 py-2 rounded-lg font-semibold hover:bg-yellow-400 transition"
          >
            Make an Appointment
          </a>
        </div>
      ...
      <div className="container mx-auto px-4 py-20 text-center">
        ...
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block bg-yellow-500 text-blue-900 px-8 py-4 rounded-lg font-bold text-lg hover:bg-yellow-400 transition shadow-lg"
        >
          Listen to the Show
        </a>
      </div>
